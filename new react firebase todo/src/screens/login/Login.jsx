...
const password = useRef()  
  ...
  return (
    <Box sx={{height:'80vh'}} className='d-flex justify-content-center align-item-center'>
      <form onSubmit={login} className='d-flex justify-content-center mt-5 flex-column w-25 gap-5'>
      ...
      <Button type='submit' variant="contained">{loading ? <CircularProgress sx={{color: 'white'}} size={30}/> : 'Login'}</Button>
      </form>
    </Box>
  )
}
